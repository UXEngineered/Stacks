 ...
 * Keeps dependencies minimal and allows full Tailwind styling
 */
...
export function FolderPlusIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
export function HistoryIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
